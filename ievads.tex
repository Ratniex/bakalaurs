...
% kaut kāds paragrāfs par to kas ir blokķēde
...
Vēlākas implementācijas stipri paplašināja ķēdes funkcionalitāti un atrisināja daudzas tehniskas \textbf{Bitcoin} problēmas, piemēram, pieaugošo vēstures izmēru un nespēju augt līdzi pieaugošam transakciju skaitam.% citation needed 
...
% paskaidrot kas ir cross chain transactions
