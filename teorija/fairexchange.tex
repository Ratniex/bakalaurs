Par \textbf{aprakstu} $Desc: \m \rightarrow \left\{ \t, \f \right\}$ sauc funkciju, kura nosaka, vai ziņojumam piemīt vēlamās īpašības. Ziņojums $x$ atbilst aprakstam $x$, ja $Desc(x) = \t$.
